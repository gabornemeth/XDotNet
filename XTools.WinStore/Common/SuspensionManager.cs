    ...
    internal sealed class SuspensionManager
    {
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                // DownloadAsync an output stream for the SessionState file and write the state asynchronously
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                // DownloadAsync the input stream for the SessionState file
